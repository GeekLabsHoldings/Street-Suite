    ...
    return (
        <div className='flex items-start gap-8'>
            <div className='w-4/5'>
                ...
                <div className={styles.trainings_most_liked + " flex gap-[50px]"}>
                    <div className={styles.trainings + " w-2/3 space-y-4"}>
                        <Link to="/dashboard/training/single-training">
                            <div className={styles.border_animate}>
                                <div className={styles.training_card + " flex gap-[16px]"}>
                                    <img src={advancedBadge} alt="" className={styles.advanced_badge} />
                                    <div className={styles.training_card_img + " w-1/4"}>

                                    </div>
                                    <div className={styles.training_card_info + " w-3/4"}>
                                        <h4>Day Trading, Swing Trading, Position Trading</h4>
                                        <div className='my-[16px] flex items-center gap-[50px]'>
                                            <span>6 Modules</span>
                    ...
                    <div className={styles.most_liked_trainings + " w-1/3"}>
                        <h5>Most Liked</h5>
