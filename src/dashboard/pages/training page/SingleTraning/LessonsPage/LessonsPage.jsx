        ...
        <div className=" w-full space-y-8">
            ...
            <div className=" training_lison_collapse completed">
                ...
                <div className={styles.training_lison_collapse_body + " training_lison_collapse_body"}>
                    ...
                    <button className={styles.makeCompleteBtn} disabled>Completed</button>
                </div>
            </div>
            ...
            <div className=" training_lison_collapse current">
                ...
                <div className={styles.training_lison_collapse_body + " training_lison_collapse_body"}>
                    <div className='flex flex-col lg:flex-row items-start gap-[15px] lg:gap-[50px]'>
            ...
            <Link to="/dashboard/training/single-training/assessment" className={styles.assessment_btn} >Assessment</Link>
