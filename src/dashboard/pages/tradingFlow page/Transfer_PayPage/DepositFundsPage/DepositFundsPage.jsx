    ...
    return (
        <>
            ...
            <div className={styles.bank_transfer_transaction_card}>
                ...
                <div className={styles.card_body + " grid grid-cols-1 lg:grid-cols-3 gap-x-20 gap-y-8 lg:gap-y-16 mb-8 lg:mb-20"}>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li className='flex items-center justify-between'>
                            ...
                            <div className={styles.tooltip}>
                                <button onClick={(e) => copyText(e)} onMouseOut={(e) => outcopyText(e)}><img src={copyIcon} alt="" />
                ...
                <button className={styles.confirm_btn} onClick={()=>navigate("/dashboard/trading/transfer&pay/seccssful-transaction")}>Complete Transaction</button>
