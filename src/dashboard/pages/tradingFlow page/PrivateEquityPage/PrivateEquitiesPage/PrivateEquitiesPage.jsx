...
const PrivateEquitiesPage = () => {
    ...
    const openCollaps = (e) => {
        ...
        $(".collapse_body").not($(e.target.offsetParent).siblings(".collapse_body")).slideUp(300);
        $(".collapse_header").not($(e.target).parents(".collapse_header")).removeClass("open")

        // toggle slide collaps by click
        $(e.target.offsetParent).siblings(".collapse_body").slideToggle(300);
        ...
        <div className={styles.private_equities_table + " private_equities_table w-full"}>
            ...
            <div className={styles.table_body + " flex flex-col gap-[15px]"}>
                <div className={styles.collapse + " equity_collapse"}>
                    <ul className="collapse_header grid grid-cols-5 gap-[1px]" onClick={(e) => openCollaps(e)}>
                        <li><img src={companyLogo} alt="" /></li>
                        <li>Finance</li>
                        <li>$200 K</li>
                        <li>Angel</li>
                        <li className='flex gap-[5px] gap-[16px]'>$ 190 <svg width="11" height="8" viewBox="0 0 11 8" fill="none" xmlns="http://www.w3.org/2000/svg">
