    ...
    return (
        ...
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Street Suite –  Disclaimer."
                />
            </Helmet>
            ...
            <div className='disclaimerBG'>
                <div className='md:w-10/12 sm:w-11/12 mx-auto md:py-20 sm:py-10 flex flex-col md:gap-20 sm:gap-12'>
                    <div className="disclaimerHeader md:w-1/2 sm:w-4/5 mx-auto text-center">
                        <h1>Disclaimer</h1>
                        <p>Please read this disclaimer before using our platform. It outlines important terms and conditions for your interaction with our services. By accessing our platform, you agree to adhere to these terms. </p>
                    </div>

                    <div className=" flex flex-col md:gap-16 sm:gap-8">
                        <div className="disclaimerContent flex flex-col md:gap-4 sm:gap-3">
                            <h4>Disclaimer</h4>
