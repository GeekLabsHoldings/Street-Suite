...
const AboutUsPage = () => {
    ...
    return (
        <div className='aboutUs-wrapper'>
            <ReactApexChart options={options} series={series} type="candlestick" height={800} />

            <div className="aboutUs-card">
                <div className="aboutUs-card-body">
                    <h4>About <span>Street Suite</span></h4>
                    ...
                    <div className="collapse-item w-full mb-6">
                        ...
                        <div className="collapse-body block">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum ea voluptatum molestias odio exercitationem velit animi blanditiis quia mollitia neque!</p>
                        </div>
                    </div>
                    <div className="collapse-item w-full mb-6">
                        <div className="collapse-header" onClick={(e) => handleCollapse(e)}>
