  ...
  return (
    ...
    <div className='quiz-wrapper'>
      ...
      <div className="quiz-score-sheet flex lg:hidden h-full gap-1 lg:gap-4 mb-[20px] lg:mb-10">
          ...
          <button className='try-again' onClick={()=>{navigate("/quezzes/quiz")}}>try again</button>
        </div>
      ...
      <div className="quizzes-cards space-y-6">
        ...
        <div className='title flex items-center justify-between'>
          <h6>More Quizzes</h6>
          <Link to="/quizzes">See More <svg width="10" height="23" viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg">
