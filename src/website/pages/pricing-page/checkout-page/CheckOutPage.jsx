...
const CheckOutPage = () => {
    ...
    return (
        <div className='checkout-wrapper'>
            ...
            <div className='lg:container mx-auto px-4 checkout-container py-20 flex items-center justify-center '>

                <div className="payment-details w-2/5">
                ...
                <div className="chosen-plan w-2/5 flex justify-end">
