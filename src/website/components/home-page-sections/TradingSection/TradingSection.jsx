...
import tradingImg from "../../../assets/home Trading img.svg"
...
const TradingSction = () => {
    return (
        ...
        <section className='trading'>
            ...
            <div className="mx-auto lg:px-4 grid grid-cols-1 lg:grid-cols-2 gap-[2vw] gap-y-6 trading-container columns-8">
                ...
                <div className="trading-content space-y-[1vw]">
                    ...
                    <div className="private-companies-box grid md:grid-cols-2">
                        ...
                        <div className="item">
                            ...
                            <div className="price">
                                <p>$ <span>190</span></p>
                                <svg viewBox="0 0 30 23" fill="#D94111" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="item">
                            ...
                            <div className="price up">
                                <p>$ <span>190</span></p>
                                <svg viewBox="0 0 30 23" fill="#118F4B" xmlns="http://www.w3.org/2000/svg">
