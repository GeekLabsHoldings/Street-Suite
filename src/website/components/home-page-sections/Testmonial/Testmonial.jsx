...
const Testmonial = () => {
    return (
        ...
        <section className='testmonial'>
            ...
            <div className='lg:container mx-auto px-0 py-4 md:px-4 grid grid-flow-row md:grid-cols-2 gap-4 md:gap-8 md:gap-y-6 testmonial-container columns-8 overflow-x-scroll' >
                {/* card of client  */}
