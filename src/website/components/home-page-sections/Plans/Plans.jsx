...
const Plans = () => {
    return (
        ...
        <section className='plans'>
            ...
            <div className='mx-auto px-0 md:px-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 gap-y-6 plans-container md:columns-8 flex items-center md:items-end justify-start lg:justify-around'>
