...
const AlertsSection = () => {
  return (
    <section className="alerts">
      ...
      <div className="mx-auto px-[5%] 2xl:px-[10%] grid  lg:grid-cols-2 grid-cols-1 alerts-container columns-8">
        ...
        <div className="alert-card">
          ...
          <div className="content">
            <p>
              Updates every 10 Secs <br /> Phone or PC Notifications
            </p>
          </div>
        </div>
        ...
        <div className="alert-card">
          ...
          <div className="content">
            <p>
              High Risk Alerts <br /> Low Risk Alerts
            </p>
          </div>
        </div>
